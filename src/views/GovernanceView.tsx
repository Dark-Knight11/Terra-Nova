                        ...
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                <div className="flex items-center gap-3 mb-2">
                                    <span className={`px-2 py-0.5 rounded text-[10px] uppercase tracking-wider border ${prop.status === 'Active' ? 'bg-blue-500/10 border-blue-500/30 text-blue-400' :
                                        prop.status === 'Passed' ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-400' :
                            ...
                            <div className="text-right text-xs text-white/40">
                                {prop.status === 'Active' ? `Ends in ${prop.end}` : `Status: ${prop.end}`}
                            </div>
                        </div>
